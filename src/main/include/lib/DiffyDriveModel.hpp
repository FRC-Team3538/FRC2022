...
public:
    ...
    {
        return motor_model.free_speed * wpi::numbers::pi * wheel_diameter / gear_ratio / 1_tr;
    }

    units::revolutions_per_minute_t MotorSpeedForWheelSpeed(units::meters_per_second_t wheel_speed) const
    {
        return wheel_speed / (wpi::numbers::pi * wheel_diameter) * gear_ratio * 1_tr;
    }
    ...
    {
        return wheel_accel / (wpi::numbers::pi * wheel_diameter) * gear_ratio * 1_rad;
    }
