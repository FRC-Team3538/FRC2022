...
import edu.wpi.first.y2023.math.MathSharedStore;
import edu.wpi.first.y2023.math.geometry.Pose2d;
import edu.wpi.first.y2023.math.geometry.Rotation2d;
import edu.wpi.first.y2023.math.geometry.Transform2d;
import edu.wpi.first.y2023.math.geometry.Translation2d;
import edu.wpi.first.y2023.math.spline.PoseWithCurvature;
import edu.wpi.first.y2023.math.spline.Spline;
import edu.wpi.first.y2023.math.spline.SplineHelper;
import edu.wpi.first.y2023.math.spline.SplineParameterizer;
import edu.wpi.first.y2023.math.spline.SplineParameterizer.MalformedSplineException;
