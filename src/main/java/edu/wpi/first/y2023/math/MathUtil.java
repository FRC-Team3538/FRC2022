  ...
  public static double applyDeadband(double value, double deadband, double maxMagnitude) {
    if (Math.abs(value) > deadband) {
      ...
      if (value > 0.0) {
        ...
        // y - y<sub>1</sub> = (y<sub>2</sub> - y<sub>1</sub>)/(x<sub>2</sub> - x<sub>1</sub>) (x -
        // x<sub>1</sub>)
        // y = (y<sub>2</sub> - y<sub>1</sub>)/(x<sub>2</sub> - x<sub>1</sub>) (x - x<sub>1</sub>) +
        // y<sub>1</sub>
        //
        // (x<sub>1</sub>, y<sub>1</sub>) = (deadband, 0) and (x<sub>2</sub>, y<sub>2</sub>) = (max,
        // max).
        // x<sub>1</sub> = deadband
        // y<sub>1</sub> = 0
        // x<sub>2</sub> = max
        // y<sub>2</sub> = max
        //
        ...
        // y<sub>1</sub>
        //
        // (x<sub>1</sub>, y<sub>1</sub>) = (-deadband, 0) and (x<sub>2</sub>, y<sub>2</sub>) =
        // (-max, -max).
        // x<sub>1</sub> = -deadband
        // y<sub>1</sub> = 0
        // x<sub>2</sub> = -max
