...
public class Rotation3d implements Interpolatable<Rotation3d> {
  ...
  public Rotation3d(Matrix<N3, N3> rotationMatrix) {
    ...
    // the matrix is orthogonal (RR<sup>T</sup> = I) and normalized (determinant is 1).
