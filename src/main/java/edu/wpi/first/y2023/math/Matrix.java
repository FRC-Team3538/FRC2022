...
public class Matrix<R extends Num, C extends Num> {
  ...
  /**
   * Calculates the transpose, M<sup>T</sup> of this matrix.
   *
   ...
   *
   * <p>If this matrix contains L where A = LL<sup>T</sup> before the update, it will contain L
   * where LL<sup>T</sup> = A + σvv<sup>T</sup> after the update.
   *
