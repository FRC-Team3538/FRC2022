...
package edu.wpi.first.y2023.math.system.plant;
...
public final class LinearSystemId {
   ...
   * velocity]<sup>T</sup>, inputs are [voltage], and outputs are [position].
   *
   ...
   * [left velocity, right velocity]<sup>T</sup>, inputs are [left voltage, right
   * voltage]<sup>T</sup>, and outputs are [left velocity, right velocity]<sup>T</sup>.
   *
   ...
   * {@link edu.wpi.first.y2023.math.util.Units} class for converting between unit types.
   *
   ...
   * (volts/(unit/sec²). These constants cam be found using SysId. The states of the system are
   * [position, velocity]<sup>T</sup>, inputs are [voltage], and outputs are [position].
   *
   * <p>The distance unit you choose MUST be an SI unit (i.e. meters or radians). You can use the
   * {@link edu.wpi.first.y2023.math.util.Units} class for converting between unit types.
   *
