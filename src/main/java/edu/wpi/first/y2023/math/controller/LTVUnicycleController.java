...
package edu.wpi.first.y2023.math.controller;

import edu.wpi.first.math.Nat;
import edu.wpi.first.math.numbers.N2;
import edu.wpi.first.math.numbers.N3;
import edu.wpi.first.y2023.math.InterpolatingMatrixTreeMap;
...
public class LTVUnicycleController {
  ...
  public LTVUnicycleController(
    ...
    // θ̇ = ω
    //
    // Here's the model as a vector function where x = [x  y  θ]<sup>T</sup> and
    // u = [v  ω]<sup>T</sup>.
    //
    //           [v cosθ]
    // f(x, u) = [v sinθ]
