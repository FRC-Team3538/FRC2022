...
// State Machine
void AutoFiveBallBlue::NextDriveState()
{
    m_driveState++;
    m_newDriveState = true;
...
// State Machine
void AutoFiveBallBlue::NextShooterState()
{
    m_shooterState++;
    m_newShooterState = true;
...
bool AutoFiveBallBlue::FollowTrajectory(frc::Trajectory &trajectory)
{
...
bool AutoFiveBallBlue::FindVisionTarget()
{
